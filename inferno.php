...
$level=11;		//level number
$correct="flipkart";		//correct answer of this level
$image="img/11.jpeg";		//name of image to be displayed
$file="inferno.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="248" width="478"/>
<br/>
ANSWER : <input type="text" name="answer">
 <!--I only sell. I dont manufacture-->
</center>
</form>
