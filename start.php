...
$correct="nfc";		//correct answer of this level
$image="img/1.jpg";		//name of image to be displayed
$file="start.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="281" width="300"/>
<br/>
