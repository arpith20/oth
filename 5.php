...
$question = "Sing 212!";	//question
$correct="tu mere agal bagal hai::two mere agal bagal hai::two mere agal bagal::tu mere agal bagal";		//the correct answer
...
<footer id="footer">
	<p><span style="opacity: 0.1;">It's a mathematical PJ on bollywood song<!--Ans: two mere agal bagal (dont tell anyone ;)--></span></p>
</footer>
