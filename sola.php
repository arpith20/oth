...
$correct="inferno";		//correct answer of this level
$image="img/10.jpeg";		//name of image to be displayed
$file="sola.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="246" width="388"/>
<br/>
