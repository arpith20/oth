...
$question = "*ping* You have 1 new message(s)!!";	//question
$correct="0d20";		//the correct answer
...
<audio controls>
  <source src="img/decode.wav" type="audio/wav">
Your browser needs to support audio to continue (download audio from img/decode.wav).
</audio>
...
<footer id="footer">
	<p><span style="opacity: 0.1;">*beep**beep**beep**beep**beep*</span></p>
</footer>
