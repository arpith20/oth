...
$question = "";	//question
$correct="7j5v2h8c+43";		//the correct answer
...
<img src="<?echo $image?>" width="1000dp" />

<?require('./includes/html_form.php');?><!--Never take short cuts. Give the value in full-->

<?require('./includes/bottomlinks.php');?>

<footer id="footer">
	<p><span style="opacity: 0.9;">OLC<!--short forms are not allowed--></span></p>
</footer>
