...
$correct="despicable";		//correct answer of this level
$image="img/2.jpeg";	//name of image to be displayed
$file="nfc.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="322" width="503"/>
<br/>
