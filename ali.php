...
$level=14;		//level number
$correct="salt lake stadium";		//correct answer of this level
$image="img/14.jpeg";		//name of image to be displayed
$file="ali.php";	//Name of the current file
...
if((strpos($ans,$correct)!==false)) 
{
	...
	header('Location:salt_lake_stadium.php');	
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="394" width="551"/>
<br/>
