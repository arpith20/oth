...
$correct="ipl";		//correct answer of this level
$image="img/8.jpeg";		//name of image to be displayed
$file="bmtc.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="298" width="287"/>
<br/>
