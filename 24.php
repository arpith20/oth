...
$question = "A pig with a pen can only write like the image below.<br/>
After this much of time IISC was able to solve the well known Vigenere cipher.";	//question
$correct="unlock me::unlockme";		//the correct answer
...
<footer id="footer">
	<p><span style="opacity: 0.6;">Key: Who was able to solve the well known Vigenere cipher as per the question?</span></p>
</footer>
