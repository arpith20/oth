...
$correct="salsa";		//correct answer of this level
$image="img/4.jpeg";		//name of image to be displayed
$file="maglev.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="240" width="390"/>
<br/>
ANSWER : <input type="text" name="answer">
</center>
</form>
<!--Place of origin of this sauce is Mexico-->
