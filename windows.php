...
$correct="lays";
$image="img/6.jpeg";		//correct answer of this level		//name of image to be displayed
$file="windows.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="244" width="425"/>
<br/>
