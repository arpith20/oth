...
$correct="bmtc";		//correct answer of this level
$image="img/7.jpeg";		//name of image to be displayed
$file="lays.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="658" width="750"/>
<br/>
