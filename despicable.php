...
$correct="maglev";		//correct answer of this level
$image="img/3.jpeg";		//name of image to be displayed
$file="despicable.php";	//Name of the current file
...
<center>
CONNECT<br/>
<img src="<?echo $image?>" height="194" width="559"/>
<br/>
